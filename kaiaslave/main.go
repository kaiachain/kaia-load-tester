...
import (
	...
	"github.com/kaiachain/kaia-load-tester/klayslave/blockbench/analyticTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/blockbench/doNothingTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/blockbench/ioHeavyTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/blockbench/smallBankTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/blockbench/ycsbTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/cpuHeavyTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/erc20TransferTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/erc721TransferTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/ethereumTxAccessListTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/ethereumTxDynamicFeeTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/ethereumTxLegacyTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/internalTxTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/largeMemoTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newAccountCreationTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newAccountUpdateTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newCancelTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newEthereumAccessListTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newEthereumDynamicFeeTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedAccountUpdateTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedAccountUpdateWithRatioTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedCancelTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedCancelWithRatioTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedSmartContractDeployTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedSmartContractDeployWithRatioTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedSmartContractExecutionTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedSmartContractExecutionWithRatioTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedValueTransferMemoTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedValueTransferMemoWithRatioTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedValueTransferTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newFeeDelegatedValueTransferWithRatioTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newSmartContractDeployTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newSmartContractExecutionTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newValueTransferLargeMemoTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newValueTransferMemoTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newValueTransferSmallMemoTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newValueTransferTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/newValueTransferWithCancelTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/readApiCallContractTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/readApiCallTC"
	receiptCheckTc "github.com/kaiachain/kaia-load-tester/klayslave/receiptCheckTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/storageTrieWriteTC"
	"github.com/kaiachain/kaia-load-tester/klayslave/transferSignedTc"
	"github.com/kaiachain/kaia-load-tester/klayslave/transferSignedWithCheckTc"
	"github.com/kaiachain/kaia-load-tester/klayslave/transferUnsignedTc"
	"github.com/kaiachain/kaia-load-tester/klayslave/userStorageTC"
...
func deploySmartContract(contractDeployFn contractDeployFunc, contractName string) *account.Account {
	...
	deployedContract := account.NewKaiaAccountWithAddr(1, addr)
...
func deploySingleSmartContract(erc20DeployAcc *account.Account, contractDeployFn contractDeployFunc, contractName string) *account.Account {
	...
	for err != nil {
		if err == account.AlreadyDeployedErr {
			...
			return account.NewKaiaAccountWithAddr(1, erc20Addr)
		}
...
func prepareAccounts() {
	...
	for i := 0; i < nUserForNewAccounts; i++ {
		accGrpForNewAccounts = append(accGrpForNewAccounts, account.NewKaiaAccount(i))
	}
}
