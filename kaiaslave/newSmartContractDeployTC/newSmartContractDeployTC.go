package newSmartContractDeployTC
...
const Name = "newSmartContractDeployTC"
...
func Run() {
	...
	if err == nil {
		boomer.Events.Publish("request_success", "http", "transferNewSmartContractDeployTx"+" to "+endPoint, elapsed, int64(10))
		cliPool.Free(cli)
	} else {
		boomer.Events.Publish("request_failure", "http", "transferNewSmartContractDeployTx"+" to "+endPoint, elapsed, err.Error())
	}
}
