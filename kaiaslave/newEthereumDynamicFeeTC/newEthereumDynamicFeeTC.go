package newEthereumDynamicFeeTC
...
const Name = "newEthereumDynamicFeeTC"
...
func Run() {
	...
	if err != nil {
		boomer.Events.Publish("request_failure", "http", "transferNewEthereumDynamicFeeTx"+" to "+endPoint, elapsed, err.Error())
	}
	...
	go func(transactionHash common.Hash) {
		...
		boomer.Events.Publish("request_success", "http", "transferNewEthereumDynamicFeeTx"+" to "+endPoint, elapsed, int64(10))
	}(txHash)
}
